...
if (selected == 'Calories Burnt Model'):
    ...
    if st.button('Predicted Calories Burnt'):
        calories_predicted = "You will burn around {} Calories by doing {} minutes of {}.".format(calories_model.predict([[Gender,Duration,Heart_Rate,Body_Temp]]), Duration, Exercise)
